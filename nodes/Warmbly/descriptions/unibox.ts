...
export const uniboxOperations: INodeProperties[] = [
	{
		...
		options: [
			{
				name: 'Approve Agent Draft',
				value: 'approveAgentDraft',
				action: 'Approve an agent draft',
				description: 'Approve an agent draft',
			},
			{
			...
			{
				name: 'Discard Agent Draft',
				value: 'discardAgentDraft',
				action: 'Discard an agent draft',
				description: 'Discard an agent draft',
			},
			{
				name: 'Draft Compose',
				value: 'draftCompose',
				action: 'Draft a new message with AI',
				description: 'Draft a new message with AI',
			},
			{
				name: 'Draft Reply',
				value: 'draftReply',
				action: 'Draft a reply with AI',
				description: 'Draft a reply with AI',
			},
			{
				name: 'Get Agent Drafts',
				value: 'getAgentDrafts',
				action: 'Get many agent drafts',
				description: 'Get many agent drafts',
			},
			{
				name: 'Get Compose Candidates',
				value: 'getComposeCandidates',
				action: 'Get compose recipients',
				description: 'Get compose recipients',
			},
			{
				name: 'Get Drafts',
				value: 'getDrafts',
				action: 'Get many saved drafts',
				description: 'Get many saved drafts',
			},
			{
				name: 'Get Many',
				value: 'getAll',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'EmailAccountID empty (or "auto") lets the backend pick the best mailbox for the first recipient.',
			},
			{
				displayName: 'From Tag ID',
				name: 'from_tag_id',
				type: 'string',
				default: '',
				description: 'FromTagID scopes the automatic pick to mailboxes carrying this tag ("Auto within a tag"). Ignored when EmailAccountID is explicit.',
			},
			{
				displayName: 'Idempotency Key',
				name: 'idempotencyKey',
		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'Conversations with this address, either direction',
			},
			{
				displayName: 'Agent Drafts',
				name: 'agent_drafts',
				type: 'string',
				default: '',
			},
		...
		options: [
			{
				...
				default: 'inbox',
				description: 'Folder, when set, marks every unread message in that folder for the whole workspace instead of the explicit id list.',
			},
		],
	},
	{
