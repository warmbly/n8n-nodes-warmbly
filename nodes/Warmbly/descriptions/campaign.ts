...
export const campaignOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				name: 'Estimate',
				value: 'estimate',
				action: 'Estimate campaign reach',
				description: 'Estimate campaign reach',
			},
			{
				name: 'Generate AI Variable',
				value: 'generateVariable',
				action: 'Generate an AI variable',
				description: 'Generate an AI variable',
			},
			{
				name: 'Generate Edit',
				value: 'generateEdit',
				action: 'Rewrite copy with AI',
				description: 'Rewrite copy with AI',
			},
			{
			...
			},
			{
				name: 'Get Forms',
				value: 'getForms',
				action: 'Get the forms feeding a campaign',
				description: 'Get the forms feeding a campaign',
			},
			{
				name: 'Get Logs',
				value: 'getLogs',
			...
			},
			{
				name: 'Get Overview',
				value: 'getOverview',
				action: 'Get the campaigns overview',
				description: 'Get the campaigns overview',
			},
			{
				name: 'Get Segments',
				value: 'getSegments',
				action: 'Get campaign segments',
				description: 'Get campaign segments',
			},
			{
				name: 'Get Senders',
				value: 'getSenders',
			...
			},
			{
				...
				value: 'replaceSegments',
				action: 'Replace campaign segments',
				description: 'Replace campaign segments',
			},
			{
			...
			{
				name: 'Update Step Layout',
				value: 'updateStepLayout',
				action: 'Update the sequence layout',
				description: 'Update the sequence layout',
			},
			{
...
export const campaignFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Kind defaults to "sequence". A "one_time" campaign accepts a single email step here and refuses further ones later.',
			},
			{
			...
			},
			{
				...
				type: 'json',
				default: '',
				description: 'Initial sequences (in order) — caller can also create them after. Provide as JSON.',
			},
			{
			...
			},
			{
				...
				type: 'boolean',
				default: false,
				description: 'Automatic UTM tagging (off unless sent). Empty values keep the defaults.',
			},
			{
	...
	},
	{
		...
		options: [
			...
			{
				displayName: 'Context After',
				name: 'context_after',
				type: 'string',
				default: '',
			},
			{
				displayName: 'Context Before',
				name: 'context_before',
				type: 'string',
				default: '',
				description: 'The email text on either side of the block, so the fragment fits the sentence it lands in (matches the send path). Optional.',
			},
			{
				displayName: 'Idempotency Key',
				name: 'idempotencyKey',
		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'ContactID renders the copy for a real contact of the organization instead of the placeholder one.',
			},
			{
				displayName: 'Idempotency Key',
				name: 'idempotencyKey',
	...
	},
	{
		...
		options: [
			{
				displayName: 'Acknowledge List Risk',
				name: 'acknowledge_list_risk',
				type: 'boolean',
				default: false,
				description: 'AcknowledgeListRisk launches past the bounce-risk gate: the member has read the projection and takes the risk (the list may have been verified elsewhere).',
			},
			{
				displayName: 'Idempotency Key',
				name: 'idempotencyKey',
	...
	},
	{
		...
		options: [
			...
			{
				displayName: 'Guardrail Bounce Rate Max',
				name: 'guardrail_bounce_rate_max',
				type: 'number',
				default: 0,
			},
			{
				displayName: 'Guardrail Complaint Rate Max',
				name: 'guardrail_complaint_rate_max',
				type: 'number',
				default: 0,
			},
			{
				displayName: 'Guardrail Enabled',
				name: 'guardrail_enabled',
				type: 'boolean',
				default: false,
				description: 'Auto-pause guardrails. GuardrailTrippedAt/Reason are server-owned and are cleared when the campaign is started again, so they are not settable here.',
			},
			{
				displayName: 'Guardrail Min Sample',
				name: 'guardrail_min_sample',
				type: 'number',
				default: 0,
			},
			{
				displayName: 'Guardrail Reply Rate Min',
				name: 'guardrail_reply_rate_min',
				type: 'number',
				default: 0,
			},
			{
				displayName: 'Guardrail Window Days',
